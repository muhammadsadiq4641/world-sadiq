...
const Navbar = () => {
  ...
  return (
    <div className="py-5 sticky inset-0  w-full h-full backdrop-blur-[5px] bg-[#FFFFFF08] z-10">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-8 cursor-pointer">
            ...
            <div
              ...
              className="max-[1800px]:block hidden"
            >
              <MdMenuOpen className="text-4xl text-white" />
            </div>
          </div>
        </div>
      </div>
